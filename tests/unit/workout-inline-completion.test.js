...
assert.match(workout, /body\.workout-active \.app\s*\{[^}]*overflow:\s*hidden/s);
assert.match(workout, /body\.workout-active #today\.active\s*\{[^}]*flex:\s*1 1 0;[^}]*overflow:\s*hidden/s);
assert.match(workout, /#exerciseList\s*\{[^}]*flex:\s*1 1 0;[^}]*overflow:\s*hidden/s);
assert.match(workout, /\.workout-accordion-card\.open\s*\{[^}]*min-height:\s*0;[^}]*flex:\s*1 1 0;[^}]*overflow:\s*hidden/s);
assert.match(workout, /\.workout-accordion-card\.open \.exercise-card-body\s*\{[^}]*height:\s*100%;[^}]*overflow-y:\s*auto/s);
assert.match(workout, /\.workout-completion-tile\.open\s*\{[^}]*min-height:\s*0;[^}]*flex:\s*1 1 0;[^}]*overflow:\s*hidden/s);
assert.match(workout, /\.workout-completion-content\s*\{[^}]*height:\s*100%;[^}]*overflow-y:\s*auto/s);
...
assert.match(workout, /body\.workout-active \.app\s*\{[^}]*width:\s*100%;[^}]*max-width:\s*none;[^}]*padding:\s*0 0 env\(safe-area-inset-bottom\);[^}]*background:\s*#000000/s);
