...
const CACHE_NAME = 'somthingreat-v8-91-submenu-safe-area';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-91-submenu-safe-area',
  './welcome.css?v=v8-91-submenu-safe-area',
  './auth.css?v=v8-91-submenu-safe-area',
  './workout.css?v=v8-91-submenu-safe-area',
  './account.css?v=v8-91-submenu-safe-area',
  './auth.js?v=v8-91-submenu-safe-area',
  './workouts.js?v=v8-91-submenu-safe-area',
  './state.js?v=v8-91-submenu-safe-area',
  './account.js?v=v8-91-submenu-safe-area',
  './admin.js?v=v8-91-submenu-safe-area',
  './render.js?v=v8-91-submenu-safe-area',
  './app.js?v=v8-91-submenu-safe-area',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
