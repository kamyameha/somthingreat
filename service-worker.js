...
const CACHE_NAME = 'somthingreat-v8-88-submenu-white-refresh';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-88-submenu-white-refresh',
  './welcome.css?v=v8-88-submenu-white-refresh',
  './auth.css?v=v8-88-submenu-white-refresh',
  './workout.css?v=v8-88-submenu-white-refresh',
  './account.css?v=v8-88-submenu-white-refresh',
  './auth.js?v=v8-88-submenu-white-refresh',
  './workouts.js?v=v8-88-submenu-white-refresh',
  './state.js?v=v8-88-submenu-white-refresh',
  './account.js?v=v8-88-submenu-white-refresh',
  './admin.js?v=v8-88-submenu-white-refresh',
  './render.js?v=v8-88-submenu-white-refresh',
  './app.js?v=v8-88-submenu-white-refresh',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
