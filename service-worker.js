...
const CACHE_NAME = 'somthingreat-v8-83-submenu-white-handoff';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-83-submenu-white-handoff',
  './welcome.css?v=v8-83-submenu-white-handoff',
  './auth.css?v=v8-83-submenu-white-handoff',
  './workout.css?v=v8-83-submenu-white-handoff',
  './account.css?v=v8-83-submenu-white-handoff',
  './auth.js?v=v8-83-submenu-white-handoff',
  './workouts.js?v=v8-83-submenu-white-handoff',
  './state.js?v=v8-83-submenu-white-handoff',
  './account.js?v=v8-83-submenu-white-handoff',
  './admin.js?v=v8-83-submenu-white-handoff',
  './render.js?v=v8-83-submenu-white-handoff',
  './app.js?v=v8-83-submenu-white-handoff',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
