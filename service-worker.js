...
const CACHE_NAME = 'somthingreat-v8-76-clean-screen-colors';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-76-clean-screen-colors',
  './welcome.css?v=v8-76-clean-screen-colors',
  './auth.css?v=v8-76-clean-screen-colors',
  './workout.css?v=v8-76-clean-screen-colors',
  './account.css?v=v8-76-clean-screen-colors',
  './auth.js?v=v8-76-clean-screen-colors',
  './workouts.js?v=v8-76-clean-screen-colors',
  './state.js?v=v8-76-clean-screen-colors',
  './account.js?v=v8-76-clean-screen-colors',
  './admin.js?v=v8-76-clean-screen-colors',
  './render.js?v=v8-76-clean-screen-colors',
  './app.js?v=v8-76-clean-screen-colors',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
