...
const CACHE_NAME = 'somthingreat-v8-94-account-submenu-order';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-94-account-submenu-order',
  './welcome.css?v=v8-94-account-submenu-order',
  './auth.css?v=v8-94-account-submenu-order',
  './workout.css?v=v8-94-account-submenu-order',
  './account.css?v=v8-94-account-submenu-order',
  './auth.js?v=v8-94-account-submenu-order',
  './workouts.js?v=v8-94-account-submenu-order',
  './state.js?v=v8-94-account-submenu-order',
  './account.js?v=v8-94-account-submenu-order',
  './admin.js?v=v8-94-account-submenu-order',
  './render.js?v=v8-94-account-submenu-order',
  './app.js?v=v8-94-account-submenu-order',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
