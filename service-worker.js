...
const CACHE_NAME = 'somthingreat-v8-86-submenu-white-theme';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-86-submenu-white-theme',
  './welcome.css?v=v8-86-submenu-white-theme',
  './auth.css?v=v8-86-submenu-white-theme',
  './workout.css?v=v8-86-submenu-white-theme',
  './account.css?v=v8-86-submenu-white-theme',
  './auth.js?v=v8-86-submenu-white-theme',
  './workouts.js?v=v8-86-submenu-white-theme',
  './state.js?v=v8-86-submenu-white-theme',
  './account.js?v=v8-86-submenu-white-theme',
  './admin.js?v=v8-86-submenu-white-theme',
  './render.js?v=v8-86-submenu-white-theme',
  './app.js?v=v8-86-submenu-white-theme',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
