...
const CACHE_NAME = 'somthingreat-v8-87-submenu-priority';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-87-submenu-priority',
  './welcome.css?v=v8-87-submenu-priority',
  './auth.css?v=v8-87-submenu-priority',
  './workout.css?v=v8-87-submenu-priority',
  './account.css?v=v8-87-submenu-priority',
  './auth.js?v=v8-87-submenu-priority',
  './workouts.js?v=v8-87-submenu-priority',
  './state.js?v=v8-87-submenu-priority',
  './account.js?v=v8-87-submenu-priority',
  './admin.js?v=v8-87-submenu-priority',
  './render.js?v=v8-87-submenu-priority',
  './app.js?v=v8-87-submenu-priority',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
