...
const CACHE_NAME = 'somthingreat-v8-81-screen-top-stack';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-81-screen-top-stack',
  './welcome.css?v=v8-81-screen-top-stack',
  './auth.css?v=v8-81-screen-top-stack',
  './workout.css?v=v8-81-screen-top-stack',
  './account.css?v=v8-81-screen-top-stack',
  './auth.js?v=v8-81-screen-top-stack',
  './workouts.js?v=v8-81-screen-top-stack',
  './state.js?v=v8-81-screen-top-stack',
  './account.js?v=v8-81-screen-top-stack',
  './admin.js?v=v8-81-screen-top-stack',
  './render.js?v=v8-81-screen-top-stack',
  './app.js?v=v8-81-screen-top-stack',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
