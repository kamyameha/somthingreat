...
const CACHE_NAME = 'somthingreat-v8-82-submenu-top-history';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-82-submenu-top-history',
  './welcome.css?v=v8-82-submenu-top-history',
  './auth.css?v=v8-82-submenu-top-history',
  './workout.css?v=v8-82-submenu-top-history',
  './account.css?v=v8-82-submenu-top-history',
  './auth.js?v=v8-82-submenu-top-history',
  './workouts.js?v=v8-82-submenu-top-history',
  './state.js?v=v8-82-submenu-top-history',
  './account.js?v=v8-82-submenu-top-history',
  './admin.js?v=v8-82-submenu-top-history',
  './render.js?v=v8-82-submenu-top-history',
  './app.js?v=v8-82-submenu-top-history',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
