...
const CACHE_NAME = 'somthingreat-v8-85-submenu-menu-shape';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-85-submenu-menu-shape',
  './welcome.css?v=v8-85-submenu-menu-shape',
  './auth.css?v=v8-85-submenu-menu-shape',
  './workout.css?v=v8-85-submenu-menu-shape',
  './account.css?v=v8-85-submenu-menu-shape',
  './auth.js?v=v8-85-submenu-menu-shape',
  './workouts.js?v=v8-85-submenu-menu-shape',
  './state.js?v=v8-85-submenu-menu-shape',
  './account.js?v=v8-85-submenu-menu-shape',
  './admin.js?v=v8-85-submenu-menu-shape',
  './render.js?v=v8-85-submenu-menu-shape',
  './app.js?v=v8-85-submenu-menu-shape',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
