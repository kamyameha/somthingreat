...
const CACHE_NAME = 'somthingreat-v8-84-submenu-normal-flow';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-84-submenu-normal-flow',
  './welcome.css?v=v8-84-submenu-normal-flow',
  './auth.css?v=v8-84-submenu-normal-flow',
  './workout.css?v=v8-84-submenu-normal-flow',
  './account.css?v=v8-84-submenu-normal-flow',
  './auth.js?v=v8-84-submenu-normal-flow',
  './workouts.js?v=v8-84-submenu-normal-flow',
  './state.js?v=v8-84-submenu-normal-flow',
  './account.js?v=v8-84-submenu-normal-flow',
  './admin.js?v=v8-84-submenu-normal-flow',
  './render.js?v=v8-84-submenu-normal-flow',
  './app.js?v=v8-84-submenu-normal-flow',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
