...
const CACHE_NAME = 'somthingreat-v8-79-default-status-bar';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-79-default-status-bar',
  './welcome.css?v=v8-79-default-status-bar',
  './auth.css?v=v8-79-default-status-bar',
  './workout.css?v=v8-79-default-status-bar',
  './account.css?v=v8-79-default-status-bar',
  './auth.js?v=v8-79-default-status-bar',
  './workouts.js?v=v8-79-default-status-bar',
  './state.js?v=v8-79-default-status-bar',
  './account.js?v=v8-79-default-status-bar',
  './admin.js?v=v8-79-default-status-bar',
  './render.js?v=v8-79-default-status-bar',
  './app.js?v=v8-79-default-status-bar',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
