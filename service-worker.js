...
const CACHE_NAME = 'somthingreat-v8-93-workout-counts';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-93-workout-counts',
  './welcome.css?v=v8-93-workout-counts',
  './auth.css?v=v8-93-workout-counts',
  './workout.css?v=v8-93-workout-counts',
  './account.css?v=v8-93-workout-counts',
  './auth.js?v=v8-93-workout-counts',
  './workouts.js?v=v8-93-workout-counts',
  './state.js?v=v8-93-workout-counts',
  './account.js?v=v8-93-workout-counts',
  './admin.js?v=v8-93-workout-counts',
  './render.js?v=v8-93-workout-counts',
  './app.js?v=v8-93-workout-counts',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
