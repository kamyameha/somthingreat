...
const CACHE_NAME = 'somthingreat-v8-74-ui-flow-fixes';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-74-ui-flow-fixes',
  './welcome.css?v=v8-74-ui-flow-fixes',
  './auth.css?v=v8-74-ui-flow-fixes',
  './workout.css?v=v8-74-ui-flow-fixes',
  './account.css?v=v8-74-ui-flow-fixes',
  './auth.js?v=v8-74-ui-flow-fixes',
  './workouts.js?v=v8-74-ui-flow-fixes',
  './state.js?v=v8-74-ui-flow-fixes',
  './account.js?v=v8-74-ui-flow-fixes',
  './admin.js?v=v8-74-ui-flow-fixes',
  './render.js?v=v8-74-ui-flow-fixes',
  './app.js?v=v8-74-ui-flow-fixes',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
