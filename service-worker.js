...
const CACHE_NAME = 'somthingreat-v8-32-label-case';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=v8-32-label-case',
  './welcome.css?v=v8-32-label-case',
  './auth.css?v=v8-32-label-case',
  './workout.css?v=v8-32-label-case',
  './account.css?v=v8-32-label-case',
  './auth.js?v=v8-32-label-case',
  './workouts.js?v=v8-32-label-case',
  './state.js?v=v8-32-label-case',
  './account.js?v=v8-32-label-case',
  './admin.js?v=v8-32-label-case',
  './render.js?v=v8-32-label-case',
  './app.js?v=v8-32-label-case',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
