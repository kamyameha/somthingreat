...
const CACHE_NAME = 'somthingreat-v8-90-submenu-same-shell';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-90-submenu-same-shell',
  './welcome.css?v=v8-90-submenu-same-shell',
  './auth.css?v=v8-90-submenu-same-shell',
  './workout.css?v=v8-90-submenu-same-shell',
  './account.css?v=v8-90-submenu-same-shell',
  './auth.js?v=v8-90-submenu-same-shell',
  './workouts.js?v=v8-90-submenu-same-shell',
  './state.js?v=v8-90-submenu-same-shell',
  './account.js?v=v8-90-submenu-same-shell',
  './admin.js?v=v8-90-submenu-same-shell',
  './render.js?v=v8-90-submenu-same-shell',
  './app.js?v=v8-90-submenu-same-shell',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
