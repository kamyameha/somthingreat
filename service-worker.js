...
const CACHE_NAME = 'somthingreat-v8-73-update-banner-fix';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-73-update-banner-fix',
  './welcome.css?v=v8-73-update-banner-fix',
  './auth.css?v=v8-73-update-banner-fix',
  './workout.css?v=v8-73-update-banner-fix',
  './account.css?v=v8-73-update-banner-fix',
  ...
  './app.js?v=v8-73-update-banner-fix',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
