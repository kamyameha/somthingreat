...
const CACHE_NAME = 'somthingreat-v8-92-workout-progression';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-92-workout-progression',
  './welcome.css?v=v8-92-workout-progression',
  './auth.css?v=v8-92-workout-progression',
  './workout.css?v=v8-92-workout-progression',
  './account.css?v=v8-92-workout-progression',
  './auth.js?v=v8-92-workout-progression',
  './workouts.js?v=v8-92-workout-progression',
  './state.js?v=v8-92-workout-progression',
  './account.js?v=v8-92-workout-progression',
  './admin.js?v=v8-92-workout-progression',
  './render.js?v=v8-92-workout-progression',
  './app.js?v=v8-92-workout-progression',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
