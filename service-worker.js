...
const CACHE_NAME = 'somthingreat-v8-96-account-submenu-painted';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-96-account-submenu-painted',
  './welcome.css?v=v8-96-account-submenu-painted',
  './auth.css?v=v8-96-account-submenu-painted',
  './workout.css?v=v8-96-account-submenu-painted',
  './account.css?v=v8-96-account-submenu-painted',
  './auth.js?v=v8-96-account-submenu-painted',
  './workouts.js?v=v8-96-account-submenu-painted',
  './state.js?v=v8-96-account-submenu-painted',
  './account.js?v=v8-96-account-submenu-painted',
  './admin.js?v=v8-96-account-submenu-painted',
  './render.js?v=v8-96-account-submenu-painted',
  './app.js?v=v8-96-account-submenu-painted',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
