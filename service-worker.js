...
const CACHE_NAME = 'somthingreat-v8-77-screen-top-activity-focus';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-77-screen-top-activity-focus',
  './welcome.css?v=v8-77-screen-top-activity-focus',
  './auth.css?v=v8-77-screen-top-activity-focus',
  './workout.css?v=v8-77-screen-top-activity-focus',
  './account.css?v=v8-77-screen-top-activity-focus',
  './auth.js?v=v8-77-screen-top-activity-focus',
  './workouts.js?v=v8-77-screen-top-activity-focus',
  './state.js?v=v8-77-screen-top-activity-focus',
  './account.js?v=v8-77-screen-top-activity-focus',
  './admin.js?v=v8-77-screen-top-activity-focus',
  './render.js?v=v8-77-screen-top-activity-focus',
  './app.js?v=v8-77-screen-top-activity-focus',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
