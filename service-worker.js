...
const CACHE_NAME = 'somthingreat-v8-89-submenu-shell-white';
const APP_SHELL = [
  './',
  './index.html',
  './privacy/',
  './privacy/index.html',
  './style.css?v=v8-89-submenu-shell-white',
  './welcome.css?v=v8-89-submenu-shell-white',
  './auth.css?v=v8-89-submenu-shell-white',
  './workout.css?v=v8-89-submenu-shell-white',
  './account.css?v=v8-89-submenu-shell-white',
  './auth.js?v=v8-89-submenu-shell-white',
  './workouts.js?v=v8-89-submenu-shell-white',
  './state.js?v=v8-89-submenu-shell-white',
  './account.js?v=v8-89-submenu-shell-white',
  './admin.js?v=v8-89-submenu-shell-white',
  './render.js?v=v8-89-submenu-shell-white',
  './app.js?v=v8-89-submenu-shell-white',
  './version.json',
  './manifest.json',
  './supabase-config.js',
  './somthingreat.svg',
